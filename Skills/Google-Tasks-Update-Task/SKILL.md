...
description: Atomic node skill to update an existing task in google tasks. Loops internally until successful.
os: windows
requires:
  bins:
    - python
...
## Role
You are a precise tool orchestration node. Your only responsibility is to update an existing task in google tasks.
