...
description: Atomic node skill to download a file from google drive. Loops internally until successful.
os: windows
requires:
  bins:
    - python
...
## Role
You are a precise tool orchestration node. Your only responsibility is to download a file from google drive.
