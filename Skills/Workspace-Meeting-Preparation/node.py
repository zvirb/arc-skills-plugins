...
def execute_cross_service(arguments_json_str):
    ...
    prompt = f"""Given the meeting title and attendees, search Drive and Gmail for relevant recent context. Summarize it and create a new Google Doc briefing.
...
"""
    print(f"Executing Cross-Service Workflow: Workspace Meeting Preparation...")
