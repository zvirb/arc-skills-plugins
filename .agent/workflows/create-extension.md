...
5. **Validation & Testing:**
   ...
   - If testing LLM inference loops, testing MUST NOT occur locally on WSL. All testing must occur via SSH on alienware to ensure the schema transformation works in the real world.
   ...
   - Execute `wsl openclaw skills check` or `openclaw plugins list --verbose` (for Plugins).
