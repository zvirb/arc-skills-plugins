...
* **Architectural Pivot (No Kubernetes/Docker):** We are actively replacing the legacy Kubernetes/Docker stack with a lightweight architecture consisting solely of OpenClaw Skills and Plugins. You MUST completely ignore any legacy research documentation that mentions Kubernetes, Docker, Flux CD, Kustomize, Pods, or CRDs. Focus entirely on native OpenClaw runtime execution and local environment dependencies.
